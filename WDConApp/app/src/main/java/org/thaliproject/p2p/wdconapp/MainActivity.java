...
import org.thaliproject.p2p.wdconnectorlib.WDConnector;
...
public class MainActivity extends ActionBarActivity implements WDConnector.WDCallback,TestConnectCallBack {
    ...
    CountDownTimer DisconnectGroupOwnerTimeOut = new CountDownTimer(8000, 4000) {
        public void onTick(long millisUntilFinished) {
            // not using
        }
        public void onFinish() {
    ...
    public void StartConnector() {
        ...
        startListenerThread();
        mWDConnector = new WDConnector(that, that);
        mWDConnector.Start();
    }
    ...
    @Override
    public void ConnectionStateChanged(WDConnector.ConnectionState newState) {
    ...
    @Override
    public void ListeningStateChanged(WDConnector.ListeningState newState) {
