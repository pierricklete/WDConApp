 ...
 */
public class WifiBase implements WifiP2pManager.ChannelListener, WifiP2pManager.ConnectionInfoListener,WifiP2pManager.GroupInfoListener{
    ...
    public static final String SERVICE_TYPE = "_WDCL_p2p._tcp";
